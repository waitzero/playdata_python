...
4. 개봉일로 검색(연도-월)
    ...
    def get_by_name(self, name):
        ...
        return Movie(rank=mv['순위'].values[0], mv_name=mv['영화명'].values[0], opendt=mv['개봉일'],
                     ticket_rate=mv['예매점유율'],ticket_sales=mv['예매매출액'],
                     acc_sales=mv['누적매출액'],tic_au=mv['예매관객수'], acc_au=mv['누적관객수'])
    ...
    def get_ticket_rate(self):
        return self.df.head()[['영화면', '예매점유율']].values
